...
touch /etc/trojango/.trojango.db
...
rm -rf /etc/trojango/.trojango.db
...
sleep 0.5
# trojan go
wget -O menu-trgo "https://raw.githubusercontent.com/Jengkoltunnel/supreme/main/xray/menu-trgo.sh" && chmod +x menu-trgo
wget -O addtrgo "https://raw.githubusercontent.com/Jengkoltunnel/supreme/main/xray/addtrgo.sh" && chmod +x addtrgo
wget -O trialtrojango "https://raw.githubusercontent.com/Jengkoltunnel/supreme/main/xray/trialtrojango.sh" && chmod +x trialtrojango
wget -O deltrgo "https://raw.githubusercontent.com/Jengkoltunnel/supreme/main/xray/deltrgo.sh" && chmod +x deltrgo
wget -O renewtrgo "https://raw.githubusercontent.com/Jengkoltunnel/supreme/main/xray/renewtrgo.sh" && chmod +x renewtrgo
wget -O cektrgo "https://raw.githubusercontent.com/Jengkoltunnel/supreme/main/xray/cektrgo.sh" && chmod +x cektrgo
sleep 0.5
